        ...
        initialize: function () {
            ...
            if (typeof settings === 'undefined' ||
                ...
                if (settings.storeConfig) {
                    store = new index_1["default"].RedisStore(settings.storeConfig);
                }
                var wxcCtx_1 = new component_service_1["default"](settings.wxConfig, store);
                var wxcMiddleware = function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
