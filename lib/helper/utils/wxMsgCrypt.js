...
var PrpEncrypt = (function () {
    ...
    PrpEncrypt.prototype.encode = function (msg) {
    ...
    PrpEncrypt.prototype.decode = function (encryptedMsg) {
    ...
    PrpEncrypt.prototype.genSign = function (params) {
        var token = this.token;
        var timestamp = params.timestamp, nonce = params.nonce, encrypt = params.encrypt;
