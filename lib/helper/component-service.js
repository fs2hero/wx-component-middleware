...
var ComponetService = (function () {
    function ComponetService(componetConfig, store, locker) {
        this.store = store;
        this.locker = locker;
        this.store = store;
        this.locker = locker;
        Object.assign(this, componetConfig);
        this.wxMsgCrypt = new wxMsgCrypt_1["default"]({
    ...
    ComponetService.prototype.decodeTicket = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                encryptData = wxMsgCrypt.xml2object(body).
                    xml.Encrypt._cdata;
                decodedXml = wxMsgCrypt.decrypt(encryptData);
                decodedJson = wxMsgCrypt.xml2object(decodedXml);
                return [2, decodedJson];
            });
        });
    };
    ComponetService.prototype.decryptMsg = function (msgSignature, timestamp, nonce, body) {
        return __awaiter(this, void 0, void 0, function () {
            var wxMsgCrypt, encryptData;
            return __generator(this, function (_a) {
                wxMsgCrypt = this.wxMsgCrypt;
                encryptData = wxMsgCrypt.xml2object(body).
                    xml.Encrypt._cdata;
                return [2, wxMsgCrypt.decryptMsg(msgSignature, timestamp, nonce, { Encrypt: encryptData })];
            });
        });
    };
    ComponetService.prototype.encryptMsg = function (replyMsg, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var wxMsgCrypt;
            return __generator(this, function (_a) {
                wxMsgCrypt = this.wxMsgCrypt;
                return [2, wxMsgCrypt.encryptMsg(replyMsg, opts)];
            });
        });
    };
    ComponetService.prototype.setValue = function (key, value, expire) {
    ...
    ComponetService.prototype.getValue = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ComponetService.prototype.setComponentVerifyTicket = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.setValue('component_verify_ticket', data)];
                    case 1:
                        _a.sent();
                        return [2];
                }
    ...
    ComponetService.prototype.getComponentVerifyTicket = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.getValue('component_verify_ticket')];
            });
        });
    };
    ComponetService.prototype.getComponentAccessToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var key, componentAccessToken, unLocker, component_verify_ticket, _a, newComponentAccessToken, expires_in;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, this.locker.acquireLocker()];
                    case 2:
                        unLocker = _b.sent();
                        if (!unLocker) {
                            return [2, null];
                    ...
                    case 5:
                        ...
                        return [4, this.setValue(key, newComponentAccessToken, expires_in)];
                    case 6:
                        _b.sent();
                        unLocker();
    ...
    ComponetService.prototype.getPreAuthCode = function () {
        return __awaiter(this, void 0, void 0, function () {
            var component_access_token, newAuthCode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        newAuthCode = (_a.sent()).pre_auth_code;
                        return [2, newAuthCode];
                }
            });
        });
    };
    ComponetService.prototype.getAuthorizationUrl = function (redirectUri, isPC, auth_type, biz_appid) {
        return __awaiter(this, void 0, void 0, function () {
            var preAuthCode, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ComponetService.prototype.queryAppAccessToken = function (authorization_code) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [2, authorizer_access_token];
                }
            });
        });
    };
    ComponetService.prototype.getAppAcccessToken = function (authorizer_appid) {
        return __awaiter(this, void 0, void 0, function () {
            var ATkey, RTkey, appAcccessToken, unlocker, authorizer_refresh_token, component_access_token, _a, newAT, expires_in;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ATkey = "AT:" + authorizer_appid;
                        RTkey = "RT:" + authorizer_appid;
                        return [4, this.getValue(ATkey)];
                    case 1:
                    ...
                    case 6:
                        ...
                        return [4, this.setValue(ATkey, newAT, expires_in)];
                    case 7:
                        _b.sent();
                        unlocker();
                        return [2, newAT];
