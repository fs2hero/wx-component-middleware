...
var ComponetService = (function () {
    ...
    ComponetService.prototype.decryptMsg = function (msgSignature, timestamp, nonce, data) {
        return __awaiter(this, void 0, void 0, function () {
            var wxMsgCrypt;
            return __generator(this, function (_a) {
                ...
                return [2, wxMsgCrypt.decryptMsg(msgSignature, console_1.timeStamp, nonce, data)];
            });
        });
    };
