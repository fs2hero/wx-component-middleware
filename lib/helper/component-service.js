...
var ComponetService = (function () {
    ...
    ComponetService.prototype.decodeTicket = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var wxMsgCrypt, encryptData, decodedXml, decodedJson, decodedTicket;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        decodedTicket = decodedJson.xml.ComponentVerifyTicket._cdata;
                        return [4, this.setComponentVerifyTicket(decodedTicket)];
                    case 1:
                        _a.sent();
