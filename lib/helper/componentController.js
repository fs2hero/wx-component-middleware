            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!authToken) return [3, 2];
                        return [4, this.delValue(key)];
                    case 1:
                        _a.sent();
                        return [3, 4];
                    case 2: return [4, this.setValue(key, JSON.stringify({ accessToken: authToken, expireTime: expireTime }), expireTime)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2];
    ...
    ComponentController.prototype.apiServiceFactory = function (authAppid) {
        ...
        var saveComponentToken = function (componentToken) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!componentToken) return [3, 2];
                        return [4, this.delValue(COMPONENT_TOKEN_ID)];
                    case 1:
                        _a.sent();
                        return [3, 4];
                    case 2:
        ...
        var saveToken = function (authorizerAppid, token) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!token) return [3, 2];
                        return [4, this.setAuthorizerToken(authorizerAppid)];
                    case 1:
                        _a.sent();
                        return [3, 4];
                    case 2:
